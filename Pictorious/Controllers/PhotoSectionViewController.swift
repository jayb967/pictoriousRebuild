//
//  PhotoSectionViewController.swift
//  Pictorious
//
...
public class PhotoSectionViewController: UIViewController {
    ...
    private lazy var collectionView: UICollectionView = {
        ...
        layout.itemSize = kphotoLibraryThumbnailSize
    ...
    public override func viewDidLoad() {
        ...
        let buttonImage = UIImage(named: "backButtonIcon", in: kbundle, compatibleWith: nil)?.withRenderingMode(UIImageRenderingMode.alwaysOriginal)
...
extension PhotoSectionViewController : UICollectionViewDataSource {
...
extension PhotoSectionViewController : UICollectionViewDelegateFlowLayout {
