...
internal class PermissionsView: UIView {
    ...
    func configureInView(_ view: UIView, title: String, description: String, completion: @escaping ButtonAction) {
        ...
        closeButton.setImage(UIImage(named: "retakeButton", in: kbundle, compatibleWith: nil), for: UIControlState())
    ...
    func commonInit() {
        ...
        let icon = UIImage(named: "permissionsIcon", in: kbundle, compatibleWith: nil)!
        iconView.image = icon
